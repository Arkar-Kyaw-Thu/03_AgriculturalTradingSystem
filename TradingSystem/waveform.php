...
<html lang="en">
  ...
  <body class="p-1 row">
    <div class="form-container mt-5">
      ...
      <h3 class="text-center mb-3">Pay with Wave </h3>
      <form action="" method="post">
        ...
        <label for="wave_id" class="mt-3"
          >ငွေလွှဲရန် ဖုန်းနံပါတ် 09698147391</label
        >
        <label for="wave_id" class="mt-3"
...
min-height: 30vh;" class="col">
  ...
  <div class="p-1 secondCard">
    <label>Go further with Wave Pay</label>
      <a href="https://play.google.com/store/apps/details?id=mm.com.wavemoney.wavepay&hl=en_US" style="text-decoration: none; color: #fff">
        ...
        <div>
          <form>
            <div class="form-group mt-3 p-2">
              <label>Note: Pay with your Wave Money wallet account. Make sure you have enough wallet balance.</label>
            </div>
            <div class="form-group">
              <label>1. Ensure your Wave Money account is active</label>       
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>2. Please have an active account and ensure you have sufficient balance in your accounts.</label>
            </div>
        </div>
        </div> 
    </div>
