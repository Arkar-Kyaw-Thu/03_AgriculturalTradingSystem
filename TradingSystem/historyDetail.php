...
<body>
  <header>
    <h1>
    <a href="historyPage.php" style="text-decoration: none; color: black;float: left;"><i class="fa-solid fa-arrow-left"></i></a>အသေးစိတ်အချက်အလက်များ
  </h1>
  ...
  <div class="container">
    ...
    <div class="bottom-column">
      ...
      <?php
      if($status=="uncomfrim"){
        echo "<h3 style='color:red;'>အချက်အလက်များ စီစစ်နေပါသဖြင့် ခတ္တခဏစောင့်ဆိုင်းပေးပါ။</h3>";
      }
      else if($status=="cancel"){
        echo "<h3 style='color:red;'>ငွေပေးချေမှု မအောင်မြင်ပါ။</h3>";
      }
      else{
        echo "<h3 style='color:green;'>ငွေပေးချေမှု အောင်မြင်ပါသည်။</h3>";
      }
      ?>
  </div>
</body>
